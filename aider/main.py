...
def main(argv=None, input=None, output=None, force_git_root=None, return_coder=False):
    ...
    # --- Nexus CLI: Hardwire LLM endpoint ---
    # All LLM traffic routes through the Nexus FastAPI backend.
    # The openai/ prefix tells litellm to use OpenAI-compatible routing.
    ...
    # Disable analytics — enterprise tool, no phone-home
    args.analytics_disable = True
    args.analytics = False
    # --- End Nexus CLI overrides ---
    ...
    if "nexus-agent" in args.model:
        ...
        # Auto-detect the active product skill for this repo
        try:
